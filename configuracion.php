...
define('NOMBRE_RESTAURANTE', 'DemoWebPos');
...
define('db__usuario','demowebpos'); // Nombre de usuario de base de datos
define('db__clave','w3SbYLHUfDu5WJA8'); // Clave de base de datos
define('db__db','demowebpos'); // Base de datos
